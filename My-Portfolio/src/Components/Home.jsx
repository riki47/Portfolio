  ...
  return (
    <div className='min-h-[80vh] md:min-h-[60vh]'>
      <div className='flex flex-col md:flex-row  items-center md:items-start justify-around gap-10 pt-[5rem] p-10 transition-all duration-300 min-h-[80vh] lg:min-h-[60vh]' id="home">
        ...
        <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit quas magni minus temporibus reiciendis. Voluptatem corrupti quidem minus autem reprehenderit sit ut obcaecati tempore, dicta voluptate veniam perspiciatis facere quasi?</div>
        </div>
